    ...
    return (
        <>
          {!isFetching && (
              ...
              <span
                  onClick={() => changeTypeOfChatAdding(
                      ADD_CHAT_TO_OLD_CATALOG)}
...
const mapDispatchToProps = (dispatch) => {
  return {
    changeTypeOfChatAdding: (data) => dispatch(
        changeTypeAddingChatInCatalog(data)),
    changeShowAddChatToCatalogMenu: () =>
        dispatch(changeShowAddChatToCatalog()),
